...
var BASE_PACKAGE = {
  description: 'A full Meowcoin node build with Meowcoincore',
  repository: 'https://github.com/rvnminers-A-and-N/meowcoincore',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
...
/**
 * Will create a directory and meowcoin.conf file for Meowcoin.
 * @param {String} dataDir - The absolute path
 * @param {Function} done - The callback function called when finished
 */
function createMeowcoinDirectory(datadir, done) {
...
/**
 * Will create a base Meowcoincore Node configuration directory and files.
 * @param {Object} options
 * @param {String} options.network - "testnet" or "livenet"
 * @param {String} options.datadir - The meowcoin database directory
...
function createConfigDirectory(options, configDir, isGlobal, done) {
  mkdirp(configDir, function(err) {
    ...
    try {
      fs.writeFileSync(configDir + '/meowcoincore-node.json', configJSON);
      if (!isGlobal) {
...
/**
 * Will setup a directory with a Meowcoincore Node directory, configuration file,
 * meowcoin configuration, and will install all necessary dependencies.
 *
 * @param {Object} options
 * @param {String} options.cwd - The current working directory
 * @param {String} options.dirname - The name of the meowcoincore node configuration directory
 * @param {String} options.datadir - The path to the meowcoin datadir
...
function create(options, done) {
  ...
  async.series([
    function(next) {
      // Setup the the meowcoincore-node directory and configuration
    ...
    function(next) {
      // Setup the meowcoin directory and configuration
      if (!fs.existsSync(absDataDir)) {
        createMeowcoinDirectory(absDataDir, next);
      } else {
        next();
      }
    },
