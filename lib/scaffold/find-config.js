...
/**
 * Will return the path and meowcoincore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'meowcoincore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'meowcoincore-node.json'))
  };
}
