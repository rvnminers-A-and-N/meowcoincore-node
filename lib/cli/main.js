...
var meowcoincorenode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = meowcoincorenode.version;
  var create = meowcoincorenode.scaffold.create;
  var add = meowcoincorenode.scaffold.add;
  var start = meowcoincorenode.scaffold.start;
  var remove = meowcoincorenode.scaffold.remove;
  var callMethod = meowcoincorenode.scaffold.callMethod;
  var findConfig = meowcoincorenode.scaffold.findConfig;
  var defaultConfig = meowcoincorenode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the Meowcoin database directory')
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `meowcoincore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ meowcoincore-node add wallet-service');
      console.log('    $ meowcoincore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ meowcoincore-node remove wallet-service');
      console.log('    $ meowcoincore-node remove insight-api');
      console.log();
    });
